...
namespace Cod3rsGrowth.Forms.Forms
{
    public partial class TelaCriarConvenioForm : Form
    {
        ...
        public TelaCriarConvenioForm()
        {
            InitializeComponent();
        }

        private void AoPintar_TelaCriarConvenioForm(object sender, EventArgs e)
        {
            _enderecoCriado = new();
        ...
        private void AoRequererPintura_TelaCriarConvenioForm(object sender, PaintEventArgs e)
        {
